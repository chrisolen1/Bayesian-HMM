...
from .utils import label_generator, dirichlet_generator, shrink_probabilities, normal_gamma_rvs, normal_gamma_pdf
...
class HDPHMM(object):
    ...
    def _get_beta_mixture_variables_posterior_parameters(self):
